...
def create_dynamic_setting(device_id: int, group_num: int, parameter: str, 
                          low_threshold: float, high_threshold: float,
                          behavior: int) -> Tuple[int, int, str]:
    """
    ...
    VALUES (?, ?, ?, ?, ?, ?)
    """
    execute_insert(query, (device_id, group_num, parameter, low_threshold, high_threshold, behavior))
    return (device_id, group_num, parameter)

def get_dynamic_setting(device_id: int, group_num: int, parameter: str) -> Optional[Dict[str, Any]]:
    """
...
def get_parameter_dynamic_settings(device_id: int, parameter: str) -> List[Dict[str, Any]]:
    """
...
def update_dynamic_setting(device_id: int, group_num: int, parameter: str,
                          low_threshold: Optional[float] = None,
                          high_threshold: Optional[float] = None,
                          behavior: Optional[int] = None) -> int:
    """
