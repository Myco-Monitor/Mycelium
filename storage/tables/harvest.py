...
def create_harvest(
    ...
    return execute_insert(
        query, (harvest_ts, bulk_id, total_wt, trimmed_wt, unit_id, weight_used)
    )
...
def get_harvests_by_date_range(
...
def update_harvest(
    harvest_id: int,
    harvest_ts: Optional[str] = None,
    total_wt: Optional[float] = None,
    trimmed_wt: Optional[float] = None,
    bulk_id: Optional[int] = None,
    unit_id: Optional[int] = None,
