...
def create_spawn(total_wt: float, bag_wt: float, bag_count: int,
                unit_id: Optional[int] = None, bag_id: Optional[int] = None,
                prep_notes: Optional[str] = None, start_ts: Optional[str] = None,
                inoculated_ts: Optional[str] = None, finished_ts: Optional[str] = None) -> int:
    """
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    """
    return execute_insert(query, (unit_id, total_wt, bag_id, bag_wt, bag_count,
                                 prep_notes, start_ts, inoculated_ts, finished_ts))
...
def get_spawn_by_date_range(start_date: str, end_date: Optional[str] = None) -> List[Dict[str, Any]]:
    """
...
def update_spawn(spawn_id: int, total_wt: Optional[float] = None, 
                bag_wt: Optional[float] = None, bag_count: Optional[int] = None,
                unit_id: Optional[int] = None, bag_id: Optional[int] = None,
                prep_notes: Optional[str] = None, start_ts: Optional[str] = None,
                inoculated_ts: Optional[str] = None, finished_ts: Optional[str] = None) -> int:
    """
...
def update_spawn_status(spawn_id: int, start_ts: Optional[str] = None,
                       inoculated_ts: Optional[str] = None, 
                       finished_ts: Optional[str] = None) -> int:
    """
    ...
    return update_spawn(spawn_id, start_ts=start_ts, 
                       inoculated_ts=inoculated_ts, finished_ts=finished_ts)
