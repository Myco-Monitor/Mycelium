...
def create_grow_room(farm_id: int, room_name: str, room_desc: Optional[str] = None) -> int:
    """
...
def get_all_grow_rooms(farm_id: Optional[int] = None, active_only: bool = True) -> List[Dict[str, Any]]:
    """
...
def update_grow_room(room_id: int, room_name: Optional[str] = None, 
                    room_desc: Optional[str] = None) -> int:
    """
