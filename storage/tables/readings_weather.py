...
def create_reading(device_id: int, reading_ts: str, current_temp: Optional[float] = None,
                  feels_like: Optional[float] = None, humidity: Optional[float] = None,
                  ambient_pressure: Optional[float] = None) -> Tuple[int, str]:
    """
    ...
    VALUES (?, ?, ?, ?, ?, ?)
    """
    execute_insert(query, (device_id, reading_ts, current_temp, feels_like, 
                         humidity, ambient_pressure))
...
def update_reading(device_id: int, reading_ts: str, current_temp: Optional[float] = None,
                  feels_like: Optional[float] = None, humidity: Optional[float] = None,
                  ambient_pressure: Optional[float] = None) -> int:
    """
