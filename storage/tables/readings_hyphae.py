...
def create_reading(device_id: int, reading_ts: str, relay_number: int, relay_state: int,
                  cooldown: Optional[int] = None, testing: int = 0,
                  hyphae_ts: Optional[str] = None) -> Tuple[int, str, int]:
    """
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?)
    """
    execute_insert(query, (device_id, reading_ts, relay_number, relay_state, 
                         cooldown, testing, hyphae_ts))
    return (device_id, reading_ts, relay_number)

def get_reading(device_id: int, reading_ts: str, relay_number: int) -> Optional[Dict[str, Any]]:
    """
...
def get_device_readings(device_id: int, relay_number: Optional[int] = None, 
                       limit: int = 100, start_ts: Optional[str] = None, 
...
def get_relay_state_history(device_id: int, relay_number: int, 
...
def update_reading(device_id: int, reading_ts: str, relay_number: int,
                  relay_state: Optional[int] = None, cooldown: Optional[int] = None,
                  testing: Optional[int] = None, hyphae_ts: Optional[str] = None) -> int:
    """
...
def delete_device_readings(device_id: int, relay_number: Optional[int] = None,
