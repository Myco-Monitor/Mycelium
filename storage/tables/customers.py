...
def create_customer(
    ...
    return execute_insert(
        query, (farm_id, customer_name, customer_info, customer_type, notes)
    )
...
def get_customer(
    ...
    if include_inactive:
        ...
        return (
            execute_query(query, (customer_id,))[0]
...
def get_customers_by_type(
    customer_type: str, include_inactive: bool = False
) -> List[Dict[str, Any]]:
    """
...
def deactivate_customer(
    customer_id: int, deactivation_reason: Optional[str] = None
) -> int:
    """
