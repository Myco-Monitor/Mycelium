...
def create_user_setting(user_name: str,
                       user_password: str,
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """
    return execute_insert(query, (user_name, user_password_hash, owm_api_key, owm_zip_code, timezone_name, 
                                 time_format, temp_pref, reset_pin, farm_id, user_role))
...
def update_user_setting(user_id: int,
                       ...
                       smtp_use_tls: Optional[str] = None) -> int:
    """
