...
def create_sales_detail(sale_id: int, harvest_id: int, weight_used: float, 
                       price: float, line_total: float, unit_id: Optional[int] = None,
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?)
    """
    return execute_insert(query, (sale_id, harvest_id, unit_id, weight_used, price, line_total, notes))
...
def update_sales_detail(detail_id: int, weight_used: Optional[float] = None,
                       price: Optional[float] = None, line_total: Optional[float] = None,
                       notes: Optional[str] = None) -> int:
    """
