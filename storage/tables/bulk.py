...
def create_bulk(total_wt: float, bag_wt: float, bag_count: int,
               spawn_id: Optional[int] = None, unit_id: Optional[int] = None, 
               bag_id: Optional[int] = None, prep_notes: Optional[str] = None,
               start_ts: Optional[str] = None, colonized_ts: Optional[str] = None, 
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """
    return execute_insert(query, (spawn_id, unit_id, total_wt, bag_id, bag_wt, bag_count,
                                 prep_notes, start_ts, colonized_ts, finished_ts))
...
def get_bulk_by_date_range(start_date: str, end_date: Optional[str] = None) -> List[Dict[str, Any]]:
    """
...
def update_bulk(bulk_id: int, total_wt: Optional[float] = None, 
...
def update_bulk_status(bulk_id: int, start_ts: Optional[str] = None,
    ...
    return update_bulk(bulk_id, start_ts=start_ts, 
                      colonized_ts=colonized_ts, finished_ts=finished_ts)
