...
def get_sales_transactions_by_customer(
...
def get_sales_transactions_by_date_range(
    start_date: str, end_date: Optional[str] = None, include_inactive: bool = False
) -> List[Dict[str, Any]]:
    """
