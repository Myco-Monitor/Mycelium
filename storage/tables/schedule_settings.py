...
def create_schedule_setting(device_id: int, group_num: int, on_time: Optional[str] = None,
                           off_time: Optional[str] = None) -> Tuple[int, int]:
    """
...
def update_schedule_setting(device_id: int, group_num: int, 
                           on_time: Optional[str] = None,
                           off_time: Optional[str] = None) -> int:
    """
