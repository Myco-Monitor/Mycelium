...
def create_utility(util_name: str, util_cost: float, util_recd: str, util_dued: str,
                  farm_id: int, util_paid: Optional[str] = None, util_note: Optional[str] = None,
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    """
    return execute_insert(query, (util_name, util_cost, util_recd, util_dued, 
                                 util_paid, util_note, farm_id, room_id))
...
def get_utilities_by_date_range(start_date: str, end_date: str, 
                               date_type: str = "due") -> List[Dict[str, Any]]:
    """
...
def get_utilities_by_farm_and_date_range(farm_id: int, start_date: str, end_date: str,
                                        date_type: str = "due") -> List[Dict[str, Any]]:
    """
...
def calculate_total_cost_by_farm(farm_id: int, start_date: Optional[str] = None,
                                end_date: Optional[str] = None, 
                                paid_only: bool = False) -> float:
    """
...
def calculate_total_cost_by_utility_name(util_name: str, start_date: Optional[str] = None,
                                        end_date: Optional[str] = None,
                                        paid_only: bool = False) -> float:
    """
...
def update_utility(unit_id: int, util_name: Optional[str] = None, 
                  util_cost: Optional[float] = None, util_recd: Optional[str] = None,
                  util_dued: Optional[str] = None, util_paid: Optional[str] = None,
                  util_note: Optional[str] = None, room_id: Optional[int] = None) -> int:
    """
